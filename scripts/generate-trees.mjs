...
const MODELS = [
  { name: 'tree-conifer', prompt: 'single low poly pine tree, dark green triangular layered foliage, brown trunk, simple stylized game asset, realistic bark texture, isolated on blank background' },
  { name: 'tree-broadleaf', prompt: 'single low poly oak tree with round green canopy, thick brown trunk, stylized game asset, realistic leaf and bark textures, isolated on blank background' },
  { name: 'tree-palm', prompt: 'single low poly tropical palm tree, curved brown trunk, large green palm fronds at top, stylized game asset, realistic textures, isolated on blank background' },
]
